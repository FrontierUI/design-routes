...
export const dashSidebar = role === 'admin' ? [...adminDashSidebar] : [...userDashSidebar];
//export const dashSidebar = role === 'admin' ? [...adminDashSidebar.filter(f=>f.direct === true)] : [...userDashSidebar.filter(f=>f.direct === true)];
