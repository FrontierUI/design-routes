...
export const clientsLogo = [
  { cLogoId: 'air', src: '/images/logoClient/workair.png' },
  { cLogoId: 'asc', src: '/images/logoClient/workasc.png' },
  { cLogoId: 'bayer', src: '/images/logoClient/workbayer.png' },
  { cLogoId: 'beachfox', src: '/images/logoClient/workbeachfox.png' },
  { cLogoId: 'bembien', src: '/images/logoClient/workbembien.png' },
  { cLogoId: 'creactco', src: '/images/logoClient/workcreactco.png' },
  { cLogoId: 'csquad', src: '/images/logoClient/workcsquad.png' },
  { cLogoId: 'faizasteel', src: '/images/logoClient/workfaizasteel.png' },
  { cLogoId: 'faw', src: '/images/logoClient/workfaw.png' },
  { cLogoId: 'getz', src: '/images/logoClient/workgetz.png' },
  { cLogoId: 'icipak', src: '/images/logoClient/workicipak.png' },
  { cLogoId: 'iil', src: '/images/logoClient/workiil.png' },
  { cLogoId: 'inverex', src: '/images/logoClient/workinverex.png' },
  { cLogoId: 'mazito', src: '/images/logoClient/workmazito.png' },
  { cLogoId: 'moosh', src: '/images/logoClient/workmoosh.png' },
  { cLogoId: 'nixon', src: '/images/logoClient/worknixon.png' },
  { cLogoId: 'rubies', src: '/images/logoClient/workrubies.png' },
  { cLogoId: 'soyoung', src: '/images/logoClient/worksoyoung.png' },
  { cLogoId: 'up', src: '/images/logoClient/workup.png' },
];
