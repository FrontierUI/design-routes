                ...
                <div className="w-full lg:w-1/2">
                  <div className="w-full space-y-2 sm:max-w-md lg:max-w-2xl md:space-y-5">
                    ...
                    <p className="mx-auto text-base lg:text-lg sm:max-w-md md:max-w-3xl">
                      ...
                      drive growth, improve user engagement and solidify your
                      online presence.
                    </p>
                    ...
                    <p className="mx-auto text-base lg:text-lg sm:max-w-md md:max-w-3xl">
                      ...
                      user-friendly online experiences. The result? Web designs
                      that align with your business objectives and help you
                      crush your goals.
                    </p>
                  </div>
                </div>
