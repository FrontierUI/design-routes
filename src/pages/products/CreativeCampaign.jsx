  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Captivate your audience with Routes.Design's creative campaign services, delivering compelling and innovative solutions tailored to your business goals." />
      </Helmet>
          ...
          <div className="flexy max-w-full mx-auto px-5 lg:px-12">
            <div className="flex flex-wrap items-center w-full">
              ...
              <div className="w-full lg:w-1/2 relative">
                ...
                >
                  <img
                    src={`${import.meta.env.VITE_BASE_API}/images/productsPages/Ads2.png`}
                    className="img-fluid"
                    alt=""
                  />
                </Tilt>
