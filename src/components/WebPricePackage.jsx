        ...
        <div className="packageTop flexStart flex-col w-full h-full py-4 space-y-4">
          ...
          <div className="w-full pt-4 max-w-full md:max-w-xs flexy lg:justify-start">
            ...
            {isLoggedIn ? (
              ...
              <Link to="/auth/sign-in" state={{ from: '/products/web-design-and-development' }} className="flexy w-full lg:w-72">
                  ...
                  <div className="flexy flex-col w-full text-slate-900 space-y-2.5 py-6">
                    ...
                    <div className="flexy">
                      ...
                      {isLoggedIn ? (
                        ...
                        <Link to="/auth/sign-in" state={{ from: '/products/web-design-and-development' }} className="primaryLink">
                          Get Started
                        </Link>
                      )}
                    </div>
