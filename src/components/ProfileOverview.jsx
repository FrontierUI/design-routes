...
const ProfileOverview = ({ TotalOrders, TotalTickets }) => {
  ...
  return (
    <div className="grid grid-cols-12 grid-flow-dense gap-6 w-full h-full  mx-auto">
          ...
          <div className="relative flex items-start justify-between w-full">
            <div className="flex items-center gap-3">
              ...
              userDetails.profile_picture !== "" ? (
                <img
                  src={`${import.meta.env.VITE_BASE_API}${userDetails.profile_picture}`}
      ...
      <div className="col-span-12 md:col-span-6 w-full bg-white rounded-lg">
        <Link to={"/dashboard/view-order-history"} className="justStartCenter gap-3 p-3">
      ...
      <div className="col-span-12 md:col-span-6 w-full bg-white rounded-lg">
        <Link to={"/dashboard/view-all-tickets"} className="justStartCenter gap-3 p-3">
